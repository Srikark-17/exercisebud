  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      if (result.documents && result.documents.length === 0) {
        ...
        signUp({ token: user, name: fullName, email: email });
      } else {
        Alert.alert(
          "Taken Username",
          "The username is already taken. Please try a different username!",
