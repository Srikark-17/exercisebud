    ...
    <View style={{ backgroundColor: "#fff", flex: 1, width: WP(100) }}>
      ...
      <View style={styles.formContainer}>
        <View style={styles.container}>
          ...
          <TouchableOpacity activeOpacity={1} onPress={(e) => submitHandler(e)}>
